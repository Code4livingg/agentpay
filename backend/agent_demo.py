"""
AgentPay Demo - Simple agent without OpenAI dependency
...
async def demo_weather_agent():
    ...
    print("\n" + "="*60)
    print("AgentPay Demo Agent - Weather Fetcher")
    print("="*60)
...
async def demo_market_agent():
    ...
    print("\n" + "="*60)
    print("AgentPay Demo Agent - Market Data Fetcher")
    print("="*60)
...
async def main():
    ...
    print("\n🤖 AgentPay Demo - Autonomous AI Agents with Payment Capabilities")
